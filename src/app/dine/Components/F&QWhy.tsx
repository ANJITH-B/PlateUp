      ...
      transition: {ease: [0.65, 0, 0.35, 1], delay: 0.1 ,duration: 1.2}}}>
        <div className="flex flex-row justify-between w-full">
          <p className="text-md font-xl flex items-start flex-col leading-8">
            Why ? <br /><span className="text-sm font-normal"><WordPopping className="mr-1" phrase='By using the Plateup card' /></span>
          </p>
        ...
        <div className="flex flex-row justify-between w-full gap-2 items-center">
          <p><WordPopping className="mr-1" phrase='To Enjoy convenience and peace of mind, knowing that your pantry is always stocked' /></p>      
