    ...
    <div className="md:h-full w-full flex flex-col items-center "> 
      ...
      <motion.div className="bg-[#507BA6] h-60 md:h-96 w-full rounded-3xl mt-[20vh] md:mt-[15vh] pt-8"
          ...
          {/* <MotionImageWrapper image={{ src: F1, alt: 'food one' }} rotation={rotation} /> */}
           <svg className="w-full " viewBox="0 0 1548 463" xmlns="http://www.w3.org/2000/svg">
            ...
            <motion.text initial={{opacity:0}} animate={{opacity:1}} transition={{delay:1}} className="text-100px] md:text-[65px] space-x-5 font-bold" style={{fill: "white"}}>   
              ...
              <tspan dx="550"> </tspan>snacks*<tspan dx="100"> dinner</tspan>
              </textPath>
          ...
          <div className="flex flex-row absolute">
            ...
            <motion.div className=" " initial={{x:'6vw', y:'-48vh' }}><MotionImageWrapper image={{ src: C1, alt: 'food one' }} rotation={rotation} /> </motion.div>
            <motion.div className=" " initial={{x:'6vw', y:'-48vh' }}><MotionImageWrapper image={{ src: C2, alt: 'food one' }} rotation={rotation} /> </motion.div>
            <motion.div className=" " initial={{x:'-4vw', y:'-42vh' }}><MotionImageWrapper image={{ src: B1, alt: 'food one' }} rotation={rotation} /> </motion.div>
            <motion.div className=" " initial={{x:'-4vw', y:'-38vh' }}><MotionImageWrapper image={{ src: F1, alt: 'food one' }} rotation={rotation} /> </motion.div>
            <motion.div className=" " initial={{x:'-4vw', y:'-38vh' }}><MotionImageWrapper image={{ src: D1, alt: 'food one' }} rotation={rotation} /> </motion.div>
            <motion.div className=" " initial={{x:'-4vw', y:'-38vh' }}><MotionImageWrapper image={{ src: S1, alt: 'food one' }} rotation={rotation} /> </motion.div>
            <motion.div className=" " initial={{x:'-4vw', y:'-38vh' }}><MotionImageWrapper image={{ src: S2, alt: 'food one' }} rotation={rotation} /> </motion.div>
          </div>
      </motion.div>   
    </div>
  );
