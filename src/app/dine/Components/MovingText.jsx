...
const MovingText = ({container}) => {
  ...
  return (
    <div className="h-full w-full "> 
        <motion.div className="bg-[#507BA6] h-96 w-full rounded-3xl mt-[15vh]"
          ...
          <svg className="w-full " viewBox="0 0 1548 463" xmlns="http://www.w3.org/2000/svg">
            <path id="curve" fill="none" 
              ...
              <motion.text initial={{opacity:0}} animate={{opacity:1}} transition={{delay:1}} className="text-5xl font-bold" style={{fill: "white"}}>
                {[...Array(3)].map((_, i) => {
