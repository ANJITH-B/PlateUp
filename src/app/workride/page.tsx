...
export default function WorkRide() {
    const globeConfig = {
        pointSize: 4,
        globeColor: "#062056",
        showAtmosphere: true,
    ...
    return (
        <div className="flex flex-row items-center justify-center py-20 h-screen bg-black relative w-full sm:min-h-[850px]">
            <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-[25rem] md:h-[40rem] px-4">
                ...
                >
                    ...
                    <p className="text-center text-sm md:text-lg font-normal text-neutral-200 max-w-lg mt-2 mx-auto">
                        Our journey to innovation is still on the road. Stay tuned as we map out a seamless commute experience, just for you.
                    </p>
                </motion.div>
            </div>
        </div>
