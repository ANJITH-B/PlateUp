  ...
  return (
    <div className="min-h-screen bg-black md:h-[40rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden  py-40">
      ...
      <div className=" z-10 w-full text-start">
        <h1 className="mt-20 md:mt-52 text-4xl md:text-8xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-gray-900 to-neutral-100">
          Plateup
        </h1>
        <p className="mt-5 font-semibold text-4xl text-neutral-300 bg-clip-text text-transparent bg-gradient-to-b to-gray-700 from-neutral-300 max-w-lg mx-auto">
