...
export const Experience = (props) => {
    ...
    const smootMouse = {
        x: useSpring(mouse.x, { stiffness: 75, damping: 50, mass: 5 }),
        y: useSpring(mouse.y, { stiffness: 75, damping: 50, mass: 5 })
    }
        ...
        <>
            ...
            {/* <motion.group scale={[3, 3, 3]}
                ...
                animate={{
                    ...
                    rotateZ: section === 5 ? 0.3 : section === 6 ? 7 : section === 7 ? 12 : section === 8 ? -0.5 : 0,
                }}>
                <Model animation={
                    section === 1 ? 'Standing' :
                        section === 2 ? 'Standing' :
